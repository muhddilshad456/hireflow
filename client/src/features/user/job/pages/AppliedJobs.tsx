...
import { getMyApplications } from "../services/userJobService";
import type {
  JobApplication,
} from "../../../../types/applicaionTypes";
...
export function AppliedJobs() {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        setLoading(true);
        const res = await getMyApplications(filters);
        console.log("result of application fetch : ", res);
